...
# jMPC Toolbox
If you are interested in (fast) Model Predictive Control, use MATLAB and like free stuff, jMPC could be for you. See the [jMPC Documentation](https://jonathancurrie.github.io/jMPC/) for details on building, tuning and deploying fast model predictive controllers using MATLAB!
...
#### Using jMPC
The best way to start using jMPC is to have a look at the [Examples](https://jonathancurrie.github.io/jMPC/examples/) on the jMPC Wiki. There are lots of problem and code examples (which all work) as well as helpful definitions. 

#### License
jMPC is released under the 3-clause BSD license, as detailed [here](https://jonathancurrie.github.io/jMPC/license/). It is free software, and is released as an open-source package.
