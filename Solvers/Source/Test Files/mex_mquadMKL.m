...
b = [1;1;1;1]; 
niter = 50; tol = 1e-6;
[xmfile,exitflag,iter] = quad_wright(H,f,A,b,niter,tol)
[xmex,exitflag,iter] = mquad_wrightMKL(H,f,A,b,niter,tol)
...
for m = 1:no_sim
    ...
    parfor n = 1:no_montec %use parallel labs for monte carlo
        ...
        tws = tic; 
        xw = mquad_wrightMKL(H,f,A,b,200,1e-6);
        Tw = toc(tws);   
...
[xmfile,exitflag,iter1] = quad_wright(H,f,A,b,50,1e-6,[])
[xmex,exitflag,iter] = mquad_wrightMKL(H,f,A,b,50,1e-6)
iter1
acc = log10(norm(xmfile-xmex))